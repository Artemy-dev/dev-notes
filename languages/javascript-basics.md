...
* **Компиляция:** Исходный код → Машинный код → Исполнение
* **Интерпретация:** Исходный код → Исполнение
* **JIT:** Исходный код → Машинный код (часто используемые участки)  → Исполнение

**Интерпретация** - это когда код выполняется построчно другой программой (интерпретатором) без предварительного преобразования в машинный код. 
<br>**Компиляция** - это когда код целиком переводится в машинный код до запуска, создавая исполняемый файл.
