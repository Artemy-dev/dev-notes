...
1. [Обзор языка JavaScript](#обзор-языка-javascript)
2. [Установка необходимого софта](#установка-необходимого-софта)
3. [Создание проекта и запуск первого скрипта](#создание-проекта-и-запуск-первого-скрипта)
4. [Комментарии](#комментарии)
5. [Переменные](#переменные)
6. [Strict mode](#strict-mode)
7. [Конкатенация](#конкатенация)
8. [Арифметические операторы](#арифметические-операторы)
9. [Операторы присваивания](#операторы-присваивания)
10. [Операторы сравнения](#операторы-сравнения)
11. [Логические операторы](#логические-операторы)
12. [Тернарный оператор](#тернарный-оператор)
13. [Типы данных](#типы-данных)
14. [Определение типа данных (typeof)](#определение-типа-данных-typeof)
15. [Преобразование типов](#преобразование-типов)
16. [Шаблонные строки](#шаблонные-строки)
17. [Методы строк](#методы-строк)
18. [Условия (if / else if / else)](#условия-if--else-if--else)
19. [Конструкция switch-case](#конструкция-switch-case)
20. [Цикл for](#цикл-for)
21. [Цикл while](#цикл-while)
22. [Цикл do...while](#цикл-dowhile)
23. [Функции](#функции)
24. [Параметры и аргументы](#параметры-и-аргументы)
25. [Вложенные функции](#вложенные-функции)
26. [Функции высшего порядка](#функции-высшего-порядка)
27. [Массивы](#массивы)
28. [Методы массивов](#методы-массивов)
29. [Сортировка массива](#сортировка-массива)
30. [Деструктуризация массива](#деструктуризация-массива)
31. [Rest-оператор](#rest-оператор)
32. [Методы split и join](#методы-split-и-join)
33. [map](#map)
34. [Объекты](#объекты)
35. [Методы объектов](#методы-объектов)
36. [Итерирование по объекту](#итерирование-по-объекту)
37. [Деструктуризация объекта](#деструктуризация-объекта)
38. [Rest и Spread в объектах](#rest-и-spread-в-объектах)
39. [Optional chaining](#optional-chaining)
40. [Область видимости (Scope)](#область-видимости-scope)
41. [Поднятие (Hoisting)](#поднятие-hoisting)
42. [this](#this)
43. [call / apply / bind](#call--apply--bind)
