...
Высокоуровневые (автоматическое управление ресурсами):
...
Низкоуровневые (ручное управление ресурсами):

* С
* Rust
* ...

*Сборщик мусора (GC) - это программа, которая сама удаляет из памяти ненужные данные (неиспользуемые переменные и объекты).*
