...
3. [Установка TypeScript](#установка-typescript)
4. [Создание файла конфигурации для компиляции TS в JS](#создание-файла-конфигурации-для-компиляции-ts-в-js)
5. [Первая программа](#первая-программа)
6. [Компиляция и запуск](#компиляция-и-запуск)
7. [Типы данных](#типы-данных)
8. [Interface / Type](#interface--type)
9. [Cast. Приведение типов (type assertion / type casting)](#cast-приведение-типов-type-assertion--type-casting)
10. [Литеральные типы](#литеральные-типы)
11. [Enums](#enums)
12. [Tuple (Кортеж)](#tuple-кортеж)
13. [Generics (Обобщения)](#generics-обобщения)
