...
* **Из HTML в JS:** JS находит кнопку (<button>) через DOM и "вешает" на нее обработчик клика
* **Логика в JS:** при клике увеличивается переменная-счетчик
* **Из JS в HTML:** JS обновляет содержимое тега <h3> через DOM, и пользователь видит новое значение на странице
